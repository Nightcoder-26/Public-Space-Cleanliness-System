...
const API_URL = "https://mock-production-api.com" || "http://localhost:5000/api";
...
// Replace "https://mock-production-api.com" dynamically
const files = walk(distPath);
files.forEach(f => {
    let c = fs.readFileSync(f, 'utf8');
    if (c.includes('"https://mock-production-api.com"')) {
